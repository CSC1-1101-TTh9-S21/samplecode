# These functions demonstrate how for loops
# can be used to do some of the functionality of for loops.
...
# Third with a for loop, but where you get the
# input from the user in the main() function and
